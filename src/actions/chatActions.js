...
export const disconnected = () => ({ type: CHAT_DISCONNECTED });

export const connectionInitiated = () => ({ type: CHAT_CONNECTION_INITIATED });
...
export const messageSent = () => ({ type: CHAT_MESSAGE_SENT });
...
export const setUserStatus = ({ username, status }) => ({
  type: CHAT_SET_USER_STATUS,
  username,
  status,
});

export const userStatusSent = () => ({ type: CHAT_USER_STATUS_SENT });
...
export const clearMessage = () => ({ type: "CHAT_MESSAGE_CLEAR" });

export const togglePicker = () => ({ type: "CHAT_TOGGLE_PICKER" });
...
export const closePicker = () => ({ type: "CHAT_CLOSE_PICKER" });

export const startSuggestions = (cursorIndex, filterSuggestions, list) => ({
  type: "CHAT_START_SUGGESTIONS",
  cursorIndex,
  filterSuggestions,
  list,
});
...
export const showSuggestions = (
  ...
  type: "CHAT_SHOW_SUGGESTIONS",
  suggestions: filterSuggestions(cursorIndex, value, list),
});
...
export const stopSuggestions = () => ({ type: "CHAT_STOP_SUGGESTIONS" });

export const downSuggestion = () => ({ type: "CHAT_DOWN_SUGGESTION" });

export const upSuggestion = () => ({ type: "CHAT_UP_SUGGESTION" });
